...
class timeLine():
    ...
    def drawer(self,date,date2,date3):
        ...
        ################################################################################################################################
        # changethe line with the repository HTTPS for example: git remote add origin <https://github.com/"username"/"repository".git>
        call('git remote add origin https://github.com/PleaseWriteYourUsername/PleaseWriteYourRepository.git', shell=True)
        ################################################################################################################################
        # commiting loop
        while (iter < 6):
